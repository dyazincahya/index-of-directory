              ...
              <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  	<ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    	<li class="nav-item">
                            <a class="nav-link" href="<?=iframeUrl($_REQUEST['a']);?>" style="color: #FFFFFF;"><abbr title="Click here if you want to see on Real Page" class="initialism">Remove Frame</abbr></a>
                        </li>
                  	</ul>
                </div>
              </div>
